...
const TEXTS = {
  uz: {
    ...
    chat_tr_off: "Tarjima o'chirilgan.",
    chat_tr_long: "Xabar juda uzun.",
    ...
    // 2026-09-22: JCh huquqi (Divizion top-48)
    wc_elig_not_ready:    "Divizion mavsumi hali yakunlanmagan",
    wc_elig_no_right:     "Divizion top-48 ga kirmagansiz",
    wc_elig_hint_wait:    "JCh'ga faqat Divizion reytingida top-{n} ga kirganlar o'ta oladi. Ro'yxat Divizion mavsumi yakunlanganda shakllanadi.",
    wc_elig_hint_no:      "JCh'ga faqat Divizion reytingida top-{n} ga kirganlar o'ta oladi. Keyingi mavsumda urinib ko'ring.",
    wc_elig_hint_yes:     "Divizionda {p}-o'rin — JCh'da o'ynash huquqiga egasiz.",
    wc_not_eligible_err:  "Sizda JCh'da ro'yxatdan o'tish huquqi yo'q.",
  ...
  ru: {
    ...
    chat_tr_off: "Перевод отключён.",
    chat_tr_long: "Сообщение слишком длинное.",
    ...
    // 2026-09-22: право участия в ЧМ (топ-48 Дивизиона)
    wc_elig_not_ready:    "Сезон Дивизиона ещё не завершён",
    wc_elig_no_right:     "Вы не вошли в топ-48 Дивизиона",
    wc_elig_hint_wait:    "В ЧМ могут зарегистрироваться только игроки из топ-{n} рейтинга Дивизиона. Список формируется после завершения сезона Дивизиона.",
    wc_elig_hint_no:      "В ЧМ могут зарегистрироваться только игроки из топ-{n} рейтинга Дивизиона. Попробуйте в следующем сезоне.",
    wc_elig_hint_yes:     "{p}-е место в Дивизионе — у вас есть право играть в ЧМ.",
    wc_not_eligible_err:  "У вас нет права регистрации в ЧМ.",
  ...
  en: {
    ...
    chat_tr_off: "Translation is off.",
    chat_tr_long: "Message is too long.",
    ...
    // 2026-09-22: World Cup eligibility (Division top-48)
    wc_elig_not_ready:    "The Division season has not ended yet",
    wc_elig_no_right:     "You are not in the Division top 48",
    wc_elig_hint_wait:    "Only the top {n} of the Division rating can join the World Cup. The list is created when the Division season ends.",
    wc_elig_hint_no:      "Only the top {n} of the Division rating can join the World Cup. Try again next season.",
    wc_elig_hint_yes:     "Place {p} in the Division — you are eligible for the World Cup.",
    wc_not_eligible_err:  "You are not eligible to register for the World Cup.",
