...
const TEXTS = {
  uz: {
    ...
    season_label:          "Mavsum",
    season_title:          "MAVSUM",
    season_current:        "Joriy mavsum",
    season_finalize_btn:   "Mavsumni yakunlash",
    season_finalize_hint:  "Sovrinlar hisoblanadi va saqlanadi, mavsum raqami oshadi",
    season_finalize_confirm: "Mavsumni yakunlaysizmi? Sovrinlar hisoblanib saqlanadi va mavsum raqami oshadi. Bu amalni ortga qaytarib bo'lmaydi.",
    season_finalized:      "Mavsum yakunlandi",
  ...
  ru: {
    ...
    season_finalize_btn:   "Завершить сезон",
    season_finalize_hint:  "Призы подсчитываются и сохраняются, номер сезона растёт",
    season_finalize_confirm: "Завершить сезон? Призы будут подсчитаны и сохранены. Это необратимо.",
    season_finalized:      "Сезон завершён",
  ...
  en: {
    ...
    season_finalize_btn:   "Finalize season",
    season_finalize_hint:  "Prizes are calculated and saved, season number increases",
    season_finalize_confirm: "Finalize the season? Prizes will be calculated and saved. This cannot be undone.",
    season_finalized:      "Season finalized",
