...
const TEXTS = {
  uz: {
    ...
    admin_redraw_keep_button: "♻️ Natijani saqlab qayta qur'a",
    ...
    admin_reopen_confirm: "Avtomatik 0:0 tasdiqlangan turlar qayta ochiladi (o'yinchilar qaytadan o'ynaydi). Qo'lda kiritilgan natijalarga tegilmaydi. Davom etasizmi?",
    admin_reopen_success: "✅ Qayta ochilgan turlar: ",
  ...
  ru: {
    ...
    admin_redraw_keep_button: "♻️ Пересоставить (сохранить результаты)",
    ...
    admin_reopen_confirm: "Туры, автоматически подтверждённые как 0:0, будут заново открыты (игроки переиграют). Введённые вручную результаты не затрагиваются. Продолжить?",
    admin_reopen_success: "✅ Заново открыто туров: ",
  ...
  en: {
    ...
    admin_redraw_keep_button: "♻️ Redraw (keep results)",
    ...
    admin_reopen_confirm: "Rounds auto-confirmed as 0:0 will be reopened (players replay them). Manually entered results are not affected. Continue?",
    admin_reopen_success: "✅ Rounds reopened: ",
